(ns stack.examples.replicant.app
  (:require
   ...
   [stack.examples.replicant.model :as model]
   [stack.examples.replicant.dispatch :as dispatch]
   [stack.examples.replicant.routes :as routes]
   [stack.examples.replicant.layout :as layout]))
