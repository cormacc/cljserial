...
N.B. AWS integration is disabled by default because it's a pain in terms of environment setup and build bloat (build file count goes from 285 -> 1243 files by just adding the auth component).
