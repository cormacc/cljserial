...
** In progress
- Icons using [[https://github.com/cjohansen/fontawesome-clj]]
...
- [[https://github.com/cjohansen/phosphor-clj][phosphor-clj icons]] :: Another icon set -- all free - may be handier than fontawesome...
