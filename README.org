...
Still figuring this out -- there are a mix of half-baked approaches in play.

The most current is that used for the webserial terminal, that uses...
...
The entrypoint is [[./src/cljserial/core.cljs]].
Routes
