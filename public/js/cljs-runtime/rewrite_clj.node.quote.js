...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k65136,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65136,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__65160){
var vec__65162 = p__65160;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65162,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65162,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65135){
var self__ = this;
var G__65135__$1 = this;
return (new cljs.core.RecordIter((0),G__65135__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65137,other65138){
var self__ = this;
var this65137__$1 = this;
return (((!((other65138 == null)))) && ((((this65137__$1.constructor === other65138.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65137__$1.tag,other65138.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65137__$1.prefix,other65138.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65137__$1.sym,other65138.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65137__$1.children,other65138.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65137__$1.__extmap,other65138.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k65136){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k65136);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__65135){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__65254 = cljs.core.keyword_identical_QMARK_;
var expr__65255 = k__5309__auto__;
if(cljs.core.truth_((pred__65254.cljs$core$IFn$_invoke$arity$2 ? pred__65254.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__65255) : pred__65254.call(null, new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__65255)))){
return (new rewrite_clj.node.quote.QuoteNode(G__65135,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65254.cljs$core$IFn$_invoke$arity$2 ? pred__65254.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__65255) : pred__65254.call(null, new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__65255)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__65135,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65254.cljs$core$IFn$_invoke$arity$2 ? pred__65254.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__65255) : pred__65254.call(null, new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__65255)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__65135,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__65254.cljs$core$IFn$_invoke$arity$2 ? pred__65254.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__65255) : pred__65254.call(null, new cljs.core.Keyword(null,"children","children",-940561982),expr__65255)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__65135,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__65135),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__65135){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__65135,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__65141){
var extmap__5342__auto__ = (function (){var G__65291 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65141,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__65141)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65291);
} else {
return G__65291;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__65141),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__65141),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__65141),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__65141),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
var G__65393 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__65393;
continue;
}
break;
...
var G__65395 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__65395;
continue;
}
break;
...
var G__65397 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__65397;
continue;
}
break;
...
var G__65400 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__65400;
continue;
}
break;
