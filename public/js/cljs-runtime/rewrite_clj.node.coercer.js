...
var comma_66536 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_66537 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_66536),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__66493){
var vec__66494 = p__66493;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66494,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66494,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_66537,rewrite_clj.node.protocols.coerce(v),comma_66536);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__66505 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__66505) : f.call(null, G__66505));
})(),sq);
});
