goog.provide('cljserial.domain');
cljserial.domain.storage_id = "cljstack";
cljserial.domain.TaskId = new cljs.core.Keyword(null,"int","int",-1741416922);
cljserial.domain.Task = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092),cljserial.domain.TaskId], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"string","string",-1989541586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"min","min",444991522),(1)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"done","done",-889844188),new cljs.core.Keyword(null,"boolean","boolean",-1919418404)], null)], null);
cljserial.domain.TaskFilter = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"enum","enum",1679018432),new cljs.core.Keyword(null,"all","all",892129742),new cljs.core.Keyword(null,"pending","pending",-220036727),new cljs.core.Keyword(null,"done","done",-889844188)], null);
cljserial.domain.task_filters = cljs.core.rest(cljserial.domain.TaskFilter);
cljserial.domain.TaskView = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tasks","tasks",-1754368880),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),cljserial.domain.Task], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"filter","filter",-948537934),cljserial.domain.TaskFilter], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"counts","counts",234305892),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"all","all",892129742),new cljs.core.Keyword(null,"int","int",-1741416922)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active","active",1895962068),new cljs.core.Keyword(null,"int","int",-1741416922)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"done","done",-889844188),new cljs.core.Keyword(null,"int","int",-1741416922)], null)], null)], null)], null);
cljserial.domain.schema = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("task","id","task/id",-1375673137),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","unique","db/unique",329396388),new cljs.core.Keyword("db.unique","identity","db.unique/identity",1675950722)], null)], null);
cljserial.domain.get_task_counts = (function cljserial$domain$get_task_counts(tasks){
...
cljserial.domain.filter_by = (function cljserial$domain$filter_by(task_filter,tasks){
var filter_fn = (function (){var G__63298 = task_filter;
var G__63298__$1 = (((G__63298 instanceof cljs.core.Keyword))?G__63298.fqn:null);
switch (G__63298__$1) {
case "pending":
...
cljserial.domain.set_task_completed = (function cljserial$domain$set_task_completed(task_id,done){
...
cljserial.domain.set_task_description = (function cljserial$domain$set_task_description(task_id,description){
...
cljserial.domain.delete_task = (function cljserial$domain$delete_task(task_id){
...
//# sourceMappingURL=cljserial.domain.js.map
