...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k65918,else__5303__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__65960){
var vec__65964 = p__65960;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65964,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65964,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65917){
var self__ = this;
var G__65917__$1 = this;
return (new cljs.core.RecordIter((0),G__65917__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65919,other65920){
var self__ = this;
var this65919__$1 = this;
return (((!((other65920 == null)))) && ((((this65919__$1.constructor === other65920.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65919__$1.tag,other65920.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65919__$1.format_string,other65920.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65919__$1.wrap_length,other65920.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65919__$1.seq_fn,other65920.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65919__$1.children,other65920.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65919__$1.__extmap,other65920.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__65993 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__65993) : self__.seq_fn.call(null, G__65993));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k65918){
var self__ = this;
var this__5307__auto____$1 = this;
var G__66008 = k65918;
var G__66008__$1 = (((G__66008 instanceof cljs.core.Keyword))?G__66008.fqn:null);
switch (G__66008__$1) {
case "tag":
case "format-string":
case "wrap-length":
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__65917){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__66015 = cljs.core.keyword_identical_QMARK_;
var expr__66016 = k__5309__auto__;
if(cljs.core.truth_((pred__66015.cljs$core$IFn$_invoke$arity$2 ? pred__66015.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__66016) : pred__66015.call(null, new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__66016)))){
return (new rewrite_clj.node.seq.SeqNode(G__65917,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66015.cljs$core$IFn$_invoke$arity$2 ? pred__66015.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__66016) : pred__66015.call(null, new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__66016)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__65917,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66015.cljs$core$IFn$_invoke$arity$2 ? pred__66015.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__66016) : pred__66015.call(null, new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__66016)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__65917,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__66015.cljs$core$IFn$_invoke$arity$2 ? pred__66015.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__66016) : pred__66015.call(null, new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__66016)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__65917,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__65917,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__65917),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__65917){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__65917,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__65921){
var extmap__5342__auto__ = (function (){var G__66049 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65921,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__65921)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__66049);
} else {
return G__66049;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__65921),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__65921),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__65921),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__65921),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__65921),null,cljs.core.not_empty(extmap__5342__auto__),null));
});

rewrite_clj.node.protocols.make_printable_BANG_(rewrite_clj.node.seq.SeqNode);
var list_node_seq_fn_66083 = (function (p1__66057_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__66057_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),list_node_seq_fn_66083,children);
});
/**
...
var map_seq_fn_66096 = (function (p1__66062_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__66062_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),map_seq_fn_66096,children);
});
