...
var len__5726__auto___77330 = arguments.length;
var i__5727__auto___77331 = (0);
while(true){
if((i__5727__auto___77331 < len__5726__auto___77330)){
args__5732__auto__.push((arguments[i__5727__auto___77331]));

var G__77332 = (i__5727__auto___77331 + (1));
i__5727__auto___77331 = G__77332;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq77223){
var G__77224 = cljs.core.first(seq77223);
var seq77223__$1 = cljs.core.next(seq77223);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__77224,seq77223__$1);
}));
...
var G__77333 = null;
var G__77333__1 = (function (msg){
return (new Error(msg));
});
var G__77333__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__77333__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__77333 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__77333__1.call(this,msg);
case 2:
return G__77333__2.call(this,msg,filename);
case 3:
return G__77333__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__77333.cljs$core$IFn$_invoke$arity$1 = G__77333__1;
G__77333.cljs$core$IFn$_invoke$arity$2 = G__77333__2;
G__77333.cljs$core$IFn$_invoke$arity$3 = G__77333__3;
return G__77333;
})()
], null),new cljs.core.Symbol(null,"cljs.core.PersistentQueue.EMPTY","cljs.core.PersistentQueue.EMPTY",399917828,null),cljs.core.PersistentQueue.EMPTY,new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__77242_SHARP_){
return (new goog.string.StringBuffer(p1__77242_SHARP_));
...
if(cljs.core.truth_(temp__5821__auto__)){
var vec__77250 = temp__5821__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77250,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77250,(1),null);
var G__77336 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__77337 = cljs.core.rest(kvs);
class__GT_opts = G__77336;
kvs = G__77337;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__77272){
var map__77273 = p__77272;
var map__77273__$1 = cljs.core.__destructure_map(map__77273);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var js_libs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"js-libs","js-libs",-502933721));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77273__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var map__77292 = opts;
var map__77292__$1 = cljs.core.__destructure_map(map__77292);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var js_libs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"js-libs","js-libs",-502933721));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__77292__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334),new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334).cljs$core$IFn$_invoke$arity$1(env));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__77292__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029),new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029).cljs$core$IFn$_invoke$arity$1(env));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77292__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
