...
var G__91630 = db;
var G__91631 = e;
var G__91632 = cljs.core.volatile_BANG_(false);
var G__91633 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__91630,G__91631,G__91632,G__91633) : datascript.impl.entity.__GT_Entity.call(null, G__91630,G__91631,G__91632,G__91633));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__91642_SHARP_,p2__91643_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__91642_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__91643_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__91644_SHARP_,p2__91645_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__91644_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__91645_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__91654_SHARP_,p2__91655_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__91654_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__91655_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5480__auto__ = (function datascript$impl$entity$js_seq_$_iter__91692(s__91693){
return (new cljs.core.LazySeq(null,(function (){
var s__91693__$1 = s__91693;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__91693__$1);
if(temp__5823__auto__){
var s__91693__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__91693__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__91693__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__91695 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__91694 = (0);
while(true){
if((i__91694 < size__5479__auto__)){
var vec__91702 = cljs.core._nth(c__5478__auto__,i__91694);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91702,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91702,(1),null);
cljs.core.chunk_append(b__91695,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__92018 = (i__91694 + (1));
i__91694 = G__92018;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__91695),datascript$impl$entity$js_seq_$_iter__91692(cljs.core.chunk_rest(s__91693__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__91695),null);
}
} else {
var vec__91711 = cljs.core.first(s__91693__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91711,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91711,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__91692(cljs.core.rest(s__91693__$2)));
}
} else {
return null;
}
...
var G__92020 = null;
var G__92020__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__91732 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__91733 = null;
var count__91734 = (0);
var i__91735 = (0);
while(true){
if((i__91735 < count__91734)){
var vec__91759 = chunk__91733.cljs$core$IIndexed$_nth$arity$2(null, i__91735);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91759,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91759,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null, v,a,this$));


var G__92028 = seq__91732;
var G__92029 = chunk__91733;
var G__92030 = count__91734;
var G__92031 = (i__91735 + (1));
seq__91732 = G__92028;
chunk__91733 = G__92029;
count__91734 = G__92030;
i__91735 = G__92031;
continue;
} else {
var temp__5823__auto__ = cljs.core.seq(seq__91732);
if(temp__5823__auto__){
var seq__91732__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__91732__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__91732__$1);
var G__92032 = cljs.core.chunk_rest(seq__91732__$1);
var G__92033 = c__5525__auto__;
var G__92034 = cljs.core.count(c__5525__auto__);
var G__92035 = (0);
seq__91732 = G__92032;
chunk__91733 = G__92033;
count__91734 = G__92034;
i__91735 = G__92035;
continue;
} else {
var vec__91762 = cljs.core.first(seq__91732__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91762,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91762,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null, v,a,this$));


var G__92039 = cljs.core.next(seq__91732__$1);
var G__92040 = null;
var G__92041 = (0);
var G__92042 = (0);
seq__91732 = G__92039;
chunk__91733 = G__92040;
count__91734 = G__92041;
i__91735 = G__92042;
continue;
}
} else {
...
var G__92020__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__91775 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__91776 = null;
var count__91777 = (0);
var i__91778 = (0);
while(true){
if((i__91778 < count__91777)){
var vec__91811 = chunk__91776.cljs$core$IIndexed$_nth$arity$2(null, i__91778);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91811,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91811,(1),null);
f.call(use_as_this,v,a,this$);


var G__92045 = seq__91775;
var G__92046 = chunk__91776;
var G__92048 = count__91777;
var G__92049 = (i__91778 + (1));
seq__91775 = G__92045;
chunk__91776 = G__92046;
count__91777 = G__92048;
i__91778 = G__92049;
continue;
} else {
var temp__5823__auto__ = cljs.core.seq(seq__91775);
if(temp__5823__auto__){
var seq__91775__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__91775__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__91775__$1);
var G__92050 = cljs.core.chunk_rest(seq__91775__$1);
var G__92051 = c__5525__auto__;
var G__92052 = cljs.core.count(c__5525__auto__);
var G__92053 = (0);
seq__91775 = G__92050;
chunk__91776 = G__92051;
count__91777 = G__92052;
i__91778 = G__92053;
continue;
} else {
var vec__91839 = cljs.core.first(seq__91775__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91839,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91839,(1),null);
f.call(use_as_this,v,a,this$);


var G__92055 = cljs.core.next(seq__91775__$1);
var G__92056 = null;
var G__92057 = (0);
var G__92058 = (0);
seq__91775 = G__92055;
chunk__91776 = G__92056;
count__91777 = G__92057;
i__91778 = G__92058;
continue;
}
} else {
...
G__92020 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__92020__1.call(this,f);
case 2:
return G__92020__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__92020.cljs$core$IFn$_invoke$arity$1 = G__92020__1;
G__92020.cljs$core$IFn$_invoke$arity$2 = G__92020__2;
return G__92020;
})()
);
...
var G__91854 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null, this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__91854);
} else {
return G__91854;
}
}
...
(datascript.impl.entity.Entity.prototype.call = (function (unused__11220__auto__){
var self__ = this;
var self__ = this;
var G__91899 = (arguments.length - (1));
switch (G__91899) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args91726){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args91726)));
}));
...
var temp__5825__auto__ = (function (){var fexpr__91923 = cljs.core.deref(this$.cache);
return (fexpr__91923.cljs$core$IFn$_invoke$arity$1 ? fexpr__91923.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__91923.call(null, attr));
})();
...
var temp__5823__auto___92104 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5823__auto___92104)){
var datoms_92105 = temp__5823__auto___92104;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_92105)));
