...
var G__62808 = o;
reagent.impl.template.goog$module$goog$object.set(G__62808,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__62985__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__62985 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__62987__i = 0, G__62987__a = new Array(arguments.length -  0);
while (G__62987__i < G__62987__a.length) {G__62987__a[G__62987__i] = arguments[G__62987__i + 0]; ++G__62987__i;}
  args = new cljs.core.IndexedSeq(G__62987__a,0,null);
} 
return G__62985__delegate.call(this,args);};
G__62985.cljs$lang$maxFixedArity = 0;
G__62985.cljs$lang$applyTo = (function (arglist__62988){
var args = cljs.core.seq(arglist__62988);
return G__62985__delegate(args);
});
...
var G__62809 = o;
reagent.impl.template.goog$module$goog$object.set(G__62809,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__63004__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63004 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63008__i = 0, G__63008__a = new Array(arguments.length -  0);
while (G__63008__i < G__63008__a.length) {G__63008__a[G__63008__i] = arguments[G__63008__i + 0]; ++G__63008__i;}
  args = new cljs.core.IndexedSeq(G__63008__a,0,null);
} 
return G__63004__delegate.call(this,args);};
G__63004.cljs$lang$maxFixedArity = 0;
G__63004.cljs$lang$applyTo = (function (arglist__63009){
var args = cljs.core.seq(arglist__63009);
return G__63004__delegate(args);
});
...
var G__62815 = props;
var G__62815__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62815,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__62815);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62815__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__62818 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62818,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__62818;
}
})(),id_class);
...
var G__62819 = (cljs.core.count(argv) - first_child);
switch (G__62819) {
case (0):
...
var vec__62826 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62826,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62826,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62826,(2),null);
...
var temp__5827__auto___63036 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___63036 == null)){
} else {
var key_63039 = temp__5827__auto___63036;
(jsprops.key = key_63039);
}
...
var temp__5827__auto___63040 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___63040 == null)){
} else {
var key_63041 = temp__5827__auto___63040;
(jsprops.key = key_63041);
}
...
var temp__5827__auto___63044 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___63044 == null)){
} else {
var key_63045 = temp__5827__auto___63044;
(jsprops.key = key_63045);
}
...
var temp__5827__auto___63056 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___63056 == null)){
} else {
var key_63057 = temp__5827__auto___63056;
(jsprops.key = key_63057);
}
...
var temp__5827__auto___63058 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___63058 == null)){
} else {
var key_63059 = temp__5827__auto___63058;
(jsprops.key = key_63059);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62860_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__62860_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__62876 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62876,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62876,(1),null);
...
break;
default:
var G__63067 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__63068 = compiler;
v = G__63067;
compiler = G__63068;
continue;
...
var G__62905 = tag;
var G__62905__$1 = (((G__62905 instanceof cljs.core.Keyword))?G__62905.fqn:null);
switch (G__62905__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template62943 = (function (opts,id,fn_to_element,parse_fn,meta62944){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta62944 = meta62944;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template62943.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_62945,meta62944__$1){
var self__ = this;
var _62945__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template62943(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta62944__$1));
}));

(reagent.impl.template.t_reagent$impl$template62943.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_62945){
var self__ = this;
var _62945__$1 = this;
return self__.meta62944;
}));

(reagent.impl.template.t_reagent$impl$template62943.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template62943.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template62943.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template62943.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template62943.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template62943.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta62944","meta62944",333792884,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template62943.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template62943.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template62943");

(reagent.impl.template.t_reagent$impl$template62943.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template62943");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template62943.
 */
reagent.impl.template.__GT_t_reagent$impl$template62943 = (function reagent$impl$template$__GT_t_reagent$impl$template62943(opts,id,fn_to_element,parse_fn,meta62944){
return (new reagent.impl.template.t_reagent$impl$template62943(opts,id,fn_to_element,parse_fn,meta62944));
});
...
return (new reagent.impl.template.t_reagent$impl$template62943(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
