...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__66461 = cljs.core.get_global_hierarchy;
return (fexpr__66461.cljs$core$IFn$_invoke$arity$0 ? fexpr__66461.cljs$core$IFn$_invoke$arity$0() : fexpr__66461.call(null, ));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__66462_SHARP_){
var _STAR_delimiter_STAR__orig_val__66463 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__66464 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__66464);

try{return rewrite_clj.parser.core.parse_next(p1__66462_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__66463);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5732__auto__ = [];
var len__5726__auto___66497 = arguments.length;
var i__5727__auto___66498 = (0);
while(true){
if((i__5727__auto___66498 < len__5726__auto___66497)){
args__5732__auto__.push((arguments[i__5727__auto___66498]));

var G__66499 = (i__5727__auto___66498 + (1));
i__5727__auto___66498 = G__66499;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__66472){
var vec__66473 = p__66472;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66473,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq66467){
var G__66468 = cljs.core.first(seq66467);
var seq66467__$1 = cljs.core.next(seq66467);
var G__66469 = cljs.core.first(seq66467__$1);
var seq66467__$2 = cljs.core.next(seq66467__$1);
var G__66470 = cljs.core.first(seq66467__$2);
var seq66467__$3 = cljs.core.next(seq66467__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__66468,G__66469,G__66470,seq66467__$3);
}));
...
var G__66487 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__66487)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__66487)){
...
return cljs.core.cons((function (){var G__66489 = rewrite_clj.reader.peek(reader);
switch (G__66489) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__66487)){
