...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__64371_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__64371_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__64371_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__64375){
var vec__64376 = p__64375;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64376,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64376,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64396__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64396__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64396__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__64407 = (function (){var or__5002__auto__ = color;
...
var fexpr__64406 = (function (){var G__64410 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__64410) : style_map.call(null, G__64410));
})();
return (fexpr__64406.cljs$core$IFn$_invoke$arity$1 ? fexpr__64406.cljs$core$IFn$_invoke$arity$1(G__64407) : fexpr__64406.call(null, G__64407));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__64425){
var vec__64426 = p__64425;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64426,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64426,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64426,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__64447){
var vec__64449 = p__64447;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64449,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64449,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64449,(2),null);
...
var G__64821 = cljs.core.next(ssv);
var G__64822 = (this_ssv == null);
var G__64823 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__64824 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__64821;
doing_nil_QMARK_ = G__64822;
last_elide = G__64823;
out = G__64824;
continue;
}
...
var vec__64517 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64517,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64517,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64517,(2),null);
...
var G__64828 = cljs.core.next(remaining_cvec);
var G__64829 = new_idx;
var G__64830 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__64828;
idx = G__64829;
out = G__64830;
continue;
}
...
var G__64836 = cljs.core.next(ss_vec);
...
var G__64838 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__64839 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__64836;
current = G__64837;
pos = G__64838;
out = G__64839;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__64608,cursor_vec){
var vec__64609 = p__64608;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64609,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64609,(1),null);
var focus_vec = vec__64609;
...
var vec__64615 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64615,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64615,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(color_fn,p__64624){
var vec__64625 = p__64624;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64625,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64625,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__64677,existing_count){
var vec__64678 = p__64677;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64678,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64678,(1),null);
...
return cljs.core.filterv((function (p1__64669_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__64669_SHARP_))));
...
var vec__64734 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64734,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64734,(1),null);
var cvec_element = vec__64734;
if((cvec_element == null)){
var G__64855 = cljs.core.next(cvec_nl);
var G__64856 = (idx + (1));
var G__64857 = start;
var G__64858 = out;
cvec_nl = G__64855;
...
var G__64859 = cljs.core.next(cvec_nl);
var G__64860 = (idx + (1));
var G__64861 = idx;
var G__64862 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__64859;
idx = G__64860;
start = G__64861;
out = G__64862;
...
var G__64863 = cljs.core.next(cvec_nl);
var G__64864 = (idx + (1));
var G__64865 = (idx + (1));
var G__64866 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__64863;
idx = G__64864;
start = G__64865;
out = G__64866;
...
var G__64867 = cljs.core.next(cvec_nl);
var G__64868 = (idx + (1));
var G__64869 = idx;
var G__64870 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__64867;
idx = G__64868;
start = G__64869;
out = G__64870;
...
var G__64873 = cljs.core.next(cvec_nl);
var G__64874 = (idx + (1));
var G__64875 = start;
var G__64876 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__64873;
idx = G__64874;
start = G__64875;
out = G__64876;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__64767_SHARP_,p2__64766_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__64766_SHARP_)){
return cljs.core.reduced(p1__64767_SHARP_);
} else {
return (p1__64767_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__64774,p__64775){
var vec__64778 = p__64774;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64778,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64778,(1),null);
var vec__64781 = p__64775;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64781,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64781,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__64798,cvec,focus_vec){
var map__64799 = p__64798;
var map__64799__$1 = cljs.core.__destructure_map(map__64799);
var options = map__64799__$1;
var map__64800 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64799__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__64800__$1 = cljs.core.__destructure_map(map__64800);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64800__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64800__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64800__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__64796_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__64796_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
