 ...
 */
uix.core.create_class = (function uix$core$create_class(p__89066){
var map__89067 = p__89066;
var map__89067__$1 = cljs.core.__destructure_map(map__89067);
var fields = map__89067__$1;
var contextType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"contextType","contextType",1033066077));
var componentDidUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",-1983477981));
var componentDidCatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"componentDidCatch","componentDidCatch",821717733));
var displayName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"displayName","displayName",-809144601));
var childContextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"childContextTypes","childContextTypes",578717991));
var getSnapshotBeforeUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"getSnapshotBeforeUpdate","getSnapshotBeforeUpdate",861122184));
var contextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"contextTypes","contextTypes",-2023853910));
var getDerivedStateFromProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"getDerivedStateFromProps","getDerivedStateFromProps",-991834739));
var getDerivedStateFromError = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"getDerivedStateFromError","getDerivedStateFromError",166658477));
var componentWillUnmount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814));
var shouldComponentUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",1795750960));
var render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"render","render",-1408033454));
var defaultProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"defaultProps","defaultProps",-533483149));
var getInitialState = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"getInitialState","getInitialState",1541760916));
var constructor$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"constructor","constructor",-1953928811));
var componentDidMount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89067__$1,new cljs.core.Keyword(null,"componentDidMount","componentDidMount",955710936));
...
var G__89107 = props.argv;
if(cljs.core.truth_(props.children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__89107,new cljs.core.Keyword(null,"children","children",-940561982),props.children);
} else {
return G__89107;
}
});
...
if((ref.current == null)){
(ref.current = (function (){var x89146 = ({"current": value});
(x89146.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x89146.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x89146.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x89146.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return (this$__$1.current = v);
}));

(x89146.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x89146.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__89176 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__89176) : f.call(null, G__89176));
})());
}));

(x89146.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__89185 = this$__$1.current;
var G__89186 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__89185,G__89186) : f.call(null, G__89185,G__89186));
})());
}));

(x89146.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__89191 = this$__$1.current;
var G__89192 = a;
var G__89193 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__89191,G__89192,G__89193) : f.call(null, G__89191,G__89192,G__89193));
})());
}));

(x89146.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
...
var G__89590__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(ref),args);
};
var G__89590 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__89592__i = 0, G__89592__a = new Array(arguments.length -  0);
while (G__89592__i < G__89592__a.length) {G__89592__a[G__89592__i] = arguments[G__89592__i + 0]; ++G__89592__i;}
  args = new cljs.core.IndexedSeq(G__89592__a,0,null);
} 
return G__89590__delegate.call(this,args);};
G__89590.cljs$lang$maxFixedArity = 0;
G__89590.cljs$lang$applyTo = (function (arglist__89593){
var args = cljs.core.seq(arglist__89593);
return G__89590__delegate(args);
});
G__89590.cljs$core$IFn$_invoke$arity$variadic = G__89590__delegate;
return G__89590;
})()
...
return (function (p1__89304_SHARP_){
var G__89306 = cljs_bean.core.bean.cljs$core$IFn$_invoke$arity$1(p1__89304_SHARP_);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__89306) : f.call(null, G__89306));
});
});
/**
 ...
 */
uix.core.create_error_boundary = (function uix$core$create_error_boundary(p__89330,render_fn){
var map__89331 = p__89330;
var map__89331__$1 = cljs.core.__destructure_map(map__89331);
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__89331__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("uix.error-boundary")));
var derive_error_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89331__$1,new cljs.core.Keyword(null,"derive-error-state","derive-error-state",-1373095498));
var did_catch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89331__$1,new cljs.core.Keyword(null,"did-catch","did-catch",2139522313));
...
var G__89354 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state.argv,set_state], null);
var G__89355 = uix.core.glue_args(props);
return (render_fn.cljs$core$IFn$_invoke$arity$2 ? render_fn.cljs$core$IFn$_invoke$arity$2(G__89354,G__89355) : render_fn.call(null, G__89354,G__89355));
});
...
var argv = (function (){var G__89376 = props.argv;
var G__89376__$1 = (cljs.core.truth_(props.children)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__89376,new cljs.core.Keyword(null,"children","children",-940561982),props.children):G__89376);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__89376__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),ref);
...
var len__5726__auto___89632 = arguments.length;
var i__5727__auto___89633 = (0);
while(true){
if((i__5727__auto___89633 < len__5726__auto___89632)){
args__5732__auto__.push((arguments[i__5727__auto___89633]));

var G__89635 = (i__5727__auto___89633 + (1));
i__5727__auto___89633 = G__89635;
continue;
} else {
}
break;
...
var update_children = (function (p1__89400_SHARP_){
if(cljs.core.truth_(p1__89400_SHARP_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
if(cljs.core.truth_((function (){var G__89448 = el;
if((G__89448 == null)){
return null;
} else {
return G__89448._store;
}
})())){
...
var nel = uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__89469 = props__$1;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__89469,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(children__$1));
} else {
return G__89469;
}
})()),[]);
...
return uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__89483 = oprops;
var G__89483__$1 = (cljs.core.truth_(okey)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__89483,new cljs.core.Keyword(null,"key","key",-1516042587),okey):G__89483);
var G__89483__$2 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__89483__$1,props__$1], 0))
;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__89483__$2,new cljs.core.Keyword(null,"children","children",-940561982),children__$1);
} else {
return G__89483__$2;
}
})()),[]);
...
/** @this {Function} */
(uix.core.clone_element.cljs$lang$applyTo = (function (seq89409){
var G__89410 = cljs.core.first(seq89409);
var seq89409__$1 = cljs.core.next(seq89409);
var G__89411 = cljs.core.first(seq89409__$1);
var seq89409__$2 = cljs.core.next(seq89409__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__89410,G__89411,seq89409__$2);
}));
