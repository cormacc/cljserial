...
return cljs.core.some((function (p1__87121_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__87121_SHARP_,"G_")){
return (component_type === uix.compiler.alpha.goog$module$goog$object.get(component_type,p1__87121_SHARP_));
} else {
return null;
}
...
var name_str_87349 = (function (){var or__5002__auto__ = component_type.displayName;
...
throw (new Error(["Invalid use of Reagent component ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_87349)," in `$` form.\n","UIx doesn't know how to render Reagent components.\n","Reagent element should be Hiccup wrapped with r/as-element, i.e. (r/as-element [",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_87349),"])"].join('')));
} else {
}
...
if(and__5000__auto__){
var G__87196 = x;
var G__87196__$1 = (((G__87196 == null))?null:G__87196.constructor);
if((G__87196__$1 == null)){
return null;
} else {
return (G__87196__$1 === Object);
}
} else {
return and__5000__auto__;
}
