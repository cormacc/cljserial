...
var map__71455 = cljs.core.meta(iobj);
var map__71455__$1 = cljs.core.__destructure_map(map__71455);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71455__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71455__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__71455__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var temp__5827__auto__ = cljs.core.meta(f);
...
var stack__$1 = sci.impl.types.stack(raw_node);
var env = new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(ctx);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(ctx);
var d = cljs.core.ex_data(e);
var st = (function (){var or__5002__auto__ = (function (){var temp__5823__auto__ = new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(d);
...
cljs.core._vreset_BANG_(st,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core._deref(st),stack__$1));
} else {
}
...
var map__71484 = (function (){var or__5002__auto__ = stack__$1;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var G__71485 = env;
var G__71485__$1 = (((G__71485 == null))?null:cljs.core.deref(G__71485));
var G__71485__$2 = (((G__71485__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__71485__$1));
var G__71485__$3 = (((G__71485__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__71485__$2,id));
var G__71485__$4 = (((G__71485__$3 == null))?null:cljs.core.deref(G__71485__$3));
var G__71485__$5 = (((G__71485__$4 == null))?null:cljs.core.last(G__71485__$4));
if((G__71485__$5 == null)){
return null;
} else {
return cljs.core.meta(G__71485__$5);
}
}
})();
var map__71484__$1 = cljs.core.__destructure_map(map__71484);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71484__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71484__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71484__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__71489 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71489,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__71489;
}
})();
...
var len__5726__auto___71585 = arguments.length;
var i__5727__auto___71586 = (0);
while(true){
if((i__5727__auto___71586 < len__5726__auto___71585)){
args__5732__auto__.push((arguments[i__5727__auto___71586]));

var G__71587 = (i__5727__auto___71586 + (1));
i__5727__auto___71586 = G__71587;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq71496){
var G__71497 = cljs.core.first(seq71496);
var seq71496__$1 = cljs.core.next(seq71496);
var G__71498 = cljs.core.first(seq71496__$1);
var seq71496__$2 = cljs.core.next(seq71496__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71497,G__71498,seq71496__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__71510 = cljs.core.namespace(sym);
switch (G__71510) {
case "clojure.core":
case "cljs.core":
...
var fexpr__71517 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__71517.cljs$core$IFn$_invoke$arity$2 ? fexpr__71517.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__71517.call(null, sci_ctx,form));
});
/**
...
return cljs.core.cons(run,(function (){var G__71518 = pred;
var G__71519 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__71518,G__71519) : sci.impl.utils.split_when.call(null, G__71518,G__71519));
})());
} else {
return null;
}
...
var G__71604 = cljs.core.next(params__$1);
var G__71605 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__71606 = lets;
params__$1 = G__71604;
new_params = G__71605;
lets = G__71606;
...
var G__71608 = cljs.core.next(params__$1);
var G__71609 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__71610 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__71608;
new_params = G__71609;
lets = G__71610;
continue;
...
var G__71540 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71540,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__71540;
}
}));
...
var args__5732__auto__ = [];
var len__5726__auto___71617 = arguments.length;
var i__5727__auto___71618 = (0);
while(true){
if((i__5727__auto___71618 < len__5726__auto___71617)){
args__5732__auto__.push((arguments[i__5727__auto___71618]));

var G__71620 = (i__5727__auto___71618 + (1));
i__5727__auto___71618 = G__71620;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq71549){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq71549));
}));
...
var G__71569 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__71569);
