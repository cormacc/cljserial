...
var G__54811 = devtools.prefs.pref(v);
v = G__54811;
continue;
} else {
return v;
...
}catch (e54758){var _e__31709__auto__ = e54758;
return false;
}})();
...
}catch (e54764){var _e__31709__auto__ = e54764;
return false;
}})();
...
}catch (e54767){var _e__31709__auto__ = e54767;
return false;
}}
}
});
...
var vec__54785 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54785,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54785,(1),null);
...
return cljs.core.some((function (p1__54792_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__54792_SHARP_);
}),template);
});
