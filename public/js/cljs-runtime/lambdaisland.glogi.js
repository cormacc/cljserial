...
var temp__5823__auto__ = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(temp__5823__auto__)){
var l = temp__5823__auto__;
...
var G__61815 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__61815 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__61815,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__61819 = cljs.core.seq(lvls);
var chunk__61821 = null;
var count__61822 = (0);
var i__61823 = (0);
while(true){
if((i__61823 < count__61822)){
var vec__61842 = chunk__61821.cljs$core$IIndexed$_nth$arity$2(null, i__61823);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61842,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61842,(1),null);
var level_61975__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_61975__$1);


var G__61976 = seq__61819;
var G__61977 = chunk__61821;
var G__61978 = count__61822;
var G__61979 = (i__61823 + (1));
seq__61819 = G__61976;
chunk__61821 = G__61977;
count__61822 = G__61978;
i__61823 = G__61979;
continue;
} else {
var temp__5823__auto__ = cljs.core.seq(seq__61819);
if(temp__5823__auto__){
var seq__61819__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__61819__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__61819__$1);
var G__61981 = cljs.core.chunk_rest(seq__61819__$1);
var G__61982 = c__5525__auto__;
var G__61983 = cljs.core.count(c__5525__auto__);
var G__61984 = (0);
seq__61819 = G__61981;
chunk__61821 = G__61982;
count__61822 = G__61983;
i__61823 = G__61984;
continue;
} else {
var vec__61849 = cljs.core.first(seq__61819__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61849,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61849,(1),null);
var level_61988__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_61988__$1);


var G__61989 = cljs.core.next(seq__61819__$1);
var G__61990 = null;
var G__61991 = (0);
var G__61992 = (0);
seq__61819 = G__61989;
chunk__61821 = G__61990;
count__61822 = G__61991;
i__61823 = G__61992;
continue;
}
} else {
...
var temp__5823__auto___61994 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5823__auto___61994)){
var instance_61996 = temp__5823__auto___61994;
instance_61996.setCapturing(true);

var instance_61998__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_61998__$1);

instance_61998__$1.setCapturing();
} else {
}
...
var G__61866 = (new goog.debug.FancyWindow());
G__61866.setEnabled(true);
...
var G__61869 = (new goog.debug.DivConsole(element));
G__61869.setCapturing(true);
...
var len__5726__auto___62002 = arguments.length;
var i__5727__auto___62003 = (0);
while(true){
if((i__5727__auto___62003 < len__5726__auto___62002)){
args__5732__auto__.push((arguments[i__5727__auto___62003]));

var G__62004 = (i__5727__auto___62003 + (1));
i__5727__auto___62003 = G__62004;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq61879){
var G__61880 = cljs.core.first(seq61879);
var seq61879__$1 = cljs.core.next(seq61879);
var G__61881 = cljs.core.first(seq61879__$1);
var seq61879__$2 = cljs.core.next(seq61879__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61880,G__61881,seq61879__$2);
}));
...
var G__61909 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__61909) : handler_fn.call(null, G__61909));
});
if(cljs.core.truth_(logger)){
var temp__5823__auto___62009 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5823__auto___62009)){
var handler_62010 = temp__5823__auto___62009;
lambdaisland.glogi.goog_removeHandler(logger,handler_62010);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__61919,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5823__auto___62015 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5823__auto___62015)){
var handler_62016 = temp__5823__auto___62015;
lambdaisland.glogi.goog_removeHandler(logger,handler_62016);
} else {
}
