...
return [(function (){var pred__63587 = cljs.core.instance_QMARK_;
var expr__63588 = reactive_val;
if(cljs.core.truth_((pred__63587.cljs$core$IFn$_invoke$arity$2 ? pred__63587.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__63588) : pred__63587.call(null, reagent.ratom.RAtom,expr__63588)))){
return "ra";
} else {
if(cljs.core.truth_((pred__63587.cljs$core$IFn$_invoke$arity$2 ? pred__63587.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__63588) : pred__63587.call(null, reagent.ratom.RCursor,expr__63588)))){
return "rc";
} else {
if(cljs.core.truth_((pred__63587.cljs$core$IFn$_invoke$arity$2 ? pred__63587.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__63588) : pred__63587.call(null, reagent.ratom.Reaction,expr__63588)))){
return "rx";
} else {
if(cljs.core.truth_((pred__63587.cljs$core$IFn$_invoke$arity$2 ? pred__63587.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__63588) : pred__63587.call(null, reagent.ratom.Track,expr__63588)))){
return "tr";
} else {
return "other";
}
