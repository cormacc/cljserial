...
var rewrite_clj$node$protocols$Node$tag$dyn_64945 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_64945(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_64958 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_64958(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_64965 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_64965(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_64974 = (function (node,opts){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_64974(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_64983 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_64983(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_64992 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_64992(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__64706_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__64706_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_65003 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_65003(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_65004 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_65004(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_65009 = (function (node,children){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_65009(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_65019 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_65019(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_65038 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_65038(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_65047 = (function (node,map_qualifier){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_65047(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_65050 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_65050(node);
}
});
...
var map__64878 = cljs.core.meta(node);
var map__64878__$1 = cljs.core.__destructure_map(map__64878);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64878__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64878__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64878__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64878__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__64883,p__64884){
var vec__64887 = p__64883;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64887,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64887,(1),null);
var vec__64890 = p__64884;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64890,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64890,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__64896 = col_extent;
if((row_extent === (0))){
return (G__64896 + col);
} else {
return G__64896;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__64916 = rewrite_clj.node.protocols.children(node);
var G__64916__$1 = (((G__64916 == null))?null:cljs.core.first(G__64916));
if((G__64916__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__64916__$1);
}
} else {
