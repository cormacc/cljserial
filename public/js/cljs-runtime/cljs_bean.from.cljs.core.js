...
var G__87271 = cljs.core.next(xs);
var G__87272 = cljs.core.next(ys);
xs = G__87271;
ys = G__87272;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__87090 = val;
var G__87091 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__87090,G__87091) : f.call(null, G__87090,G__87091));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__87104 = val__$1;
var G__87105 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__87104,G__87105) : f.call(null, G__87104,G__87105));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__87128 = val__$1;
var G__87129 = cicoll.cljs$core$IIndexed$_nth$arity$2(null, n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__87128,G__87129) : f.call(null, G__87128,G__87129));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__87290 = cljs.core.next(es);
var G__87291 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__87290;
tcoll__$1 = G__87291;
continue;
} else {
...
var G__87292 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__87293 = cljs.core.next(es);
ret = G__87292;
es = G__87293;
continue;
} else {
