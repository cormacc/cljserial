...
var vec__92065 = cljs.math.setup_hl(ix,hx__$1,lx);
var hx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92065,(0),null);
var lx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92065,(1),null);
var vec__92068 = cljs.math.setup_hl(iy,hy__$1,ly);
var hy__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92068,(0),null);
var ly__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92068,(1),null);
var vec__92071 = (function (){var n = (ix - iy);
var hx__$3 = hx__$2;
var lx__$2 = lx__$1;
while(true){
if((n === (0))){
...
var vec__92093 = (((hz < (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hx__$3 + hx__$3) + (lx__$2 >>> (31))),(lx__$2 + lx__$2)], null):((((hz | lz) === (0)))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Signed zero",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"zero","zero",-858964576),true], null))})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hz + hz) + (lz >>> (31))),(lz + lz)], null)));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92093,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92093,(1),null);
var G__92463 = (n - (1));
var G__92465 = ((4294967295) & hx__$4);
var G__92466 = ((4294967295) & lx__$3);
n = G__92463;
hx__$3 = G__92465;
lx__$2 = G__92466;
continue;
...
var hx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92071,(0),null);
var lx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92071,(1),null);
var hz = ((cljs.math.u_LT_(lx__$2,ly__$1))?((hx__$3 - hy__$2) - (1)):(hx__$3 - hy__$2));
var lz = (lx__$2 - ly__$1);
var vec__92074 = (((hz >= (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hz,lz], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hx__$3,lx__$2], null));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92074,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92074,(1),null);
...
var vec__92077 = (function (){var hx__$5 = hx__$4;
var lx__$4 = lx__$3;
var iy__$1 = iy;
while(true){
if((!((hx__$5 < (1048576))))){
...
var G__92495 = ((hx__$5 + hx__$5) + (lx__$4 >>> (31)));
var G__92496 = (lx__$4 + lx__$4);
var G__92497 = (iy__$1 - (1));
hx__$5 = G__92495;
lx__$4 = G__92496;
iy__$1 = G__92497;
continue;
...
var hx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92077,(0),null);
var lx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92077,(1),null);
var iy__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92077,(2),null);
if((iy__$1 >= (-1022))){
...
var n = ((-1022) - iy__$1);
var vec__92106 = (((n <= (20)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(hx__$5 >> n),((lx__$4 >>> n) | (hx__$5 << ((32) - n)))], null):(((n <= (31)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,((hx__$5 << ((32) - n)) | (lx__$4 >>> n))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,(hx__$5 >> (n - (32)))], null)
));
var hx__$6 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92106,(0),null);
var lx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92106,(1),null);
(i[cljs.math.HI_x] = (hx__$6 | sx));
...
var vec__92288 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92288,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92288,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__92301 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92301,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92301,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__92314 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92314,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92314,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__92342 = (((d > (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92342,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92342,(1),null);
(i[cljs.math.HI] = hr);
...
var vec__92360 = (((scaleFactor < (0)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [Math.max(scaleFactor,(- cljs.math.MAX_SCALE)),(-512),cljs.math.two_to_the_double_scale_down], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [Math.min(scaleFactor,cljs.math.MAX_SCALE),(512),cljs.math.two_to_the_double_scale_up], null));
var scale_factor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92360,(0),null);
var scale_increment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92360,(1),null);
var exp_delta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92360,(2),null);
...
var G__92623 = (d__$1 * exp_delta);
var G__92624 = (scale_factor__$1 - scale_increment);
d__$1 = G__92623;
scale_factor__$1 = G__92624;
continue;
}
break;
}
