...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_54829 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_54829(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_54833 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_54833(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_54835 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_54835(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_54839 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_54839(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_54840 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_54840(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_54841 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_54841(reader);
}
});
...
var G__54866 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__54867 = s.append(c);
c = G__54866;
s = G__54867;
continue;
}
